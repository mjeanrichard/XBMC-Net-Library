...
partial void ParseExtension(Newtonsoft.Json.Linq.JToken json);
        ...
        [Newtonsoft.Json.JsonProperty(PropertyName="dateadded")]
        ...
        protected override void Parse(Newtonsoft.Json.Linq.JToken json) {
            base.Parse(json);
            this.Dateadded = JeanRichard.Xbmc.Lib.JsonHelpers.JObjectExtensions.ParseSimpleValue<string>(json, "dateadded", "");
