...
namespace JeanRichard.Xbmc.Lib.XbmcEntities.Video {
    ...
    public partial class Streams : JeanRichard.Xbmc.Lib.JsonRpc.JsonRpcItem {
        ...
        private Array[] _audio;
        
        private Array[] _subtitle;
        
        private Array[] _video;
...
partial void ParseExtension(Newtonsoft.Json.Linq.JToken json);
        ...
        protected override void Parse(Newtonsoft.Json.Linq.JToken json) {
            base.Parse(json);
            this.Audio = JeanRichard.Xbmc.Lib.JsonHelpers.JObjectExtensions.ParseJsonObjectArray<Array>(json, "audio");
            this.Subtitle = JeanRichard.Xbmc.Lib.JsonHelpers.JObjectExtensions.ParseJsonObjectArray<Array>(json, "subtitle");
            this.Video = JeanRichard.Xbmc.Lib.JsonHelpers.JObjectExtensions.ParseJsonObjectArray<Array>(json, "video");
