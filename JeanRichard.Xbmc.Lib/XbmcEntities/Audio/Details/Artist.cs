...
namespace JeanRichard.Xbmc.Lib.XbmcEntities.Audio.Details {
    ...
    public partial class Artist : JeanRichard.Xbmc.Lib.XbmcEntities.Audio.Details.AudioDetailsBase {
        ...
        protected override void Parse(Newtonsoft.Json.Linq.JToken json) {
            ...
            this.Instrument = JeanRichard.Xbmc.Lib.JsonHelpers.JObjectExtensions.ParseSimpleValue<string>(json, "instrument", "");
            ...
            this.Yearsactive = JeanRichard.Xbmc.Lib.JsonHelpers.JObjectExtensions.ParseSimpleValue<string>(json, "yearsactive", "");
        }
    }
}
