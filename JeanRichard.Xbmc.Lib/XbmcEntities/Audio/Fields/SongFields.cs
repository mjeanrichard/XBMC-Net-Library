...
namespace JeanRichard.Xbmc.Lib.XbmcEntities.Audio.Fields {
    ...
    ///}
    /// </json>
    public class SongFields : JeanRichard.Xbmc.Lib.JsonRpc.FlagsBase<SongFields> {
        ...
        public static SongFields All = SongFields.Combine(SongFields.Title, SongFields.Artist, SongFields.AlbumArtist, SongFields.Genre, SongFields.Year, SongFields.Rating, SongFields.Album, SongFields.Track, SongFields.Duration, SongFields.Comment, SongFields.Lyrics, SongFields.MusicBrainzTrackId, SongFields.MusicBrainzArtistId, SongFields.MusicBrainzAlbumId, SongFields.MusicBrainzAlbumArtistId, SongFields.PlayCount, SongFields.FanArt, SongFields.Thumbnail, SongFields.File, SongFields.AlbumId, SongFields.LastPlayed, SongFields.Disc, SongFields.GenreId, SongFields.ArtistId, SongFields.Displayartist, SongFields.AlbumArtistId);
